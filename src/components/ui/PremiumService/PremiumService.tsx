    ...
    >
      <div className={s.placeholder_wrapper}>
        <Placeholder style={{ maxWidth: '590px' }}>
          ...
          <p>
            <Text weight="3">
              Послуга &quot;Догляд за обличчям&quot; у Lumberjack Barberhouse створена для тих, хто
              прагне не тільки виглядати бездоганно, а й відчути справжнє розслаблення та турботу.
              Це комплексний ритуал, який поєднує в собі ефективний догляд за шкірою та моменти
              релаксу.
            </Text>
          </p>
